...
$res=mysqli_query($con,"select * from `orange`");
$data=[];
...
if (isset ($_POST['delete'])) {
    $res = mysqli_query($con, "delete  from `orange` ;");
}
            ...
            <div class="card text-center text-bg-primary">
              ...
              <div class="card ">
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item bg-primary"><a href="trip silver.php">trip silver</a></li>
                    <li class="list-group-item bg-primary"><a href="trip gold.php">trip gold</a></li>
                    <li class="list-group-item bg-primary"><a href="trip vip.php">trip vip</a></li>
                  </ul>
                </div>
            </div>
          </div>

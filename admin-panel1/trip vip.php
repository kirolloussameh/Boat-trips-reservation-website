...
$res=mysqli_query($con,"select * from `fishing` where categorie='trip vip'");
$data=[];
...
if (isset($_POST['delete'])) {
    $res = mysqli_query($con, "delete from `fishing` where categorie='trip vip';");
}
      ...
      <div class="row row-cols-1 row-cols-md-3 g-4">
          ...
          <div class="col">
            <div class="card text-center text-bg-warning">
              <div class="card-body">
                <h5 class="card-title" style="color: snow;">orange package</h5>
              </div>
              <div class="card">
                  <ul class="list-group list-group-flush">

...
<section class="gallery">
    <h1>gallery</h1>
    <h3 class="photo mt-3">some photos of our trips in orange bay island</h3>
    <div class="card-group">
        <div class="card">
          <img src="assets/img/reservation photos/orange1.jpg" class="card-img-top" alt="...">
        </div>
        <div class="card">
          <img src="assets/img/reservation photos/orange2.jpg" class="card-img-top" alt="...">
        </div>
        <div class="card">
            <img src="assets/img/reservation photos/orange3.jpg" class="card-img-top" alt="...">
          </div>
      </div>
      <!--  -->
      <div class="card-group mt-4">
        <div class="card">
          <img src="assets/img/reservation photos/orange4.jpg" class="card-img-top" alt="...">
        </div>
        <div class="card">
          <img src="assets/img/reservation photos/orange5.jpg" class="card-img-top" alt="...">
        </div>
        <div class="card">
          <img src="assets/img/reservation photos/orange6.jpg" class="card-img-top" alt="...">
        </div>
      </div>
      <!--  -->
      <div class="card-group mt-4">
        <div class="card">
          <img src="assets/img/reservation photos/orange7.jpg" class="card-img-top" alt="...">
        </div>
        <div class="card">
          <img src="assets/img/reservation photos/orange8.jpg" class="card-img-top" alt="...">
        </div>
        <div class="card">
          <img src="assets/img/reservation photos/orange9.jpg" class="card-img-top" alt="...">
        </div>
      </div>
</section>
<!-- end gallery -->
...
<section class="package">
    ...
    <div class="container orange-pack">
        <div class="card mb-3">
            <img src="assets/img/orange island packages/2.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">orange island</h5>
              ...
              <h5 class="text-success"><?php
                  ...
                  ?></h5>
              <p class="card-text">Orange Bay Island 
                From 09:00am to 04:00pm.
                spend 2 Hours on Orange Island
            ...
            <div class="row">
                <div class="booking-form">
                    ...
                    <form method="post">
                        ...
                        <div class="form-btn">
                            <input class="submit-btn" type="submit" name="submit" value="Book Now"></input>
                        </div>
                    </form>
                </div>
            </div>
...
<!-- end footer -->
  ...
  <script src="js/bootstrap.min.js"></script> 
     ...
     $res3 = mysqli_query($con1, "select * from `orange` where `date`='$date'  && `email`='$email'  ");
     ...
     $res2 = mysqli_query($con1, "select * from `orange` where `email`='$email'");
     ...
     $res1 = mysqli_query($con1, "select * from `orange` where `date`='$date'");
     ...
     $res4 = mysqli_query($con1, "select * from `fishing` where `date`='$date'");
     ...
     $res5 = mysqli_query($con1, "select * from `paradise` where `date`='$date'");
     ...
     if (isset($_POST['name'],$_POST['tel'],$_POST['email'],$_POST['sel_child'],$_POST['sel_adult'],$_POST['date'])) {
         ...
         $res = mysqli_query($con, "insert into `orange` (`username`,`email`,`user_tel`,`num_child`,`num_adult`,`date`) values ('$name','$email','$tel','$child','$adult','$date')");
